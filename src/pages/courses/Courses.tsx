    ...
    <main id="courses">
      ...
      <div id="contentCourse">
        ...
        <div id="contentText">
          ...
          <p>
            Mais do que um seminário bíblico, o Carisma é uma escola que através
            da Palavra revelada e do Espírito Santo traz um ensino prático e
            vivo, empoderando você a viver o propósito pelo qual existe!
